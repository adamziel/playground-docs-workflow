...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Tools &lsaquo; My WordPress Website &#8212; WordPress</title>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396121","secure":""};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/tools.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js tools-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<li class="wp-first-item current"><a href="/wp-admin/tools.php" class="wp-first-item current" aria-current="page">Available Tools</a></li>
				...
				<div id="contextual-help-columns">
					<div class="contextual-help-tabs">
						<ul>
							...
							<li id="tab-link-converter" class="active">
								<a href="#tab-panel-converter" aria-controls="tab-panel-converter">
									Categories and Tags Converter								</a>
							</li>
													</ul>
					</div>
...
<p><a href="https://wordpress.org/documentation/article/tools-screen/">Documentation on Tools</a></p>
<p><a href="https://wordpress.org/support/forums/">Support forums</a></p>					</div>
					
					<div class="contextual-help-tabs-wrap">
						
							<div id="tab-panel-converter" class="help-tab-content active">
...
<p>The Categories and Tags Converter link on this screen will take you to the Import screen, where that Converter is one of the plugins you can install. Once that plugin is installed, the Activate Plugin &amp; Run Importer link will take you to a screen where you can choose to convert tags into categories or vice versa.</p>							</div>
												</div>
				</div>
			</div>
				</div>
...
<h1>Tools</h1>
		<div class="card">
			...
			<p>
			If you want to convert your categories to tags (or vice versa), use the <a href="/wp-admin/import.php">Categories and Tags Converter</a> available from the Import screen.			</p>
		</div>
		</div>
