...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396154","secure":""};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/privacy.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js privacy-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<div id="wpbody-content">
	...
	<div class="about__header">
		...
		<div class="about__header-text">
			We take privacy and transparency very seriously		</div>
	</div>
	...
	<nav class="about__header-navigation nav-tab-wrapper wp-clearfix" aria-label="Secondary menu">
		...
		<a href="/wp-admin/privacy.php" class="nav-tab nav-tab-active" aria-current="page">Privacy</a>
		<a href="/wp-admin/contribute.php" class="nav-tab">Get Involved</a>
	</nav>

	<div class="about__section has-2-columns is-wider-right">
		<div class="column about__image">
			<img class="privacy-image" src="/wp-admin/images/privacy.svg?ver=6.5" alt="">
		</div>
		<div class="column is-vertically-aligned-center">
			<p>From time to time, your WordPress site may send data to WordPress.org &#8212; including, but not limited to &#8212; the version you are using, and a list of installed plugins and themes.</p>

			<p>
				This data is used to provide general enhancements to WordPress, which includes helping to protect your site by finding and automatically installing new updates. It is also used to calculate statistics, such as those shown on the <a href="https://wordpress.org/about/stats/">WordPress.org stats page</a>.			</p>

			<p>
				We take privacy and transparency very seriously. To learn more about what data we collect, and how we use it, please visit <a href="https://wordpress.org/about/privacy/">our Privacy Policy</a>.			</p>
		</div>
	</div>
