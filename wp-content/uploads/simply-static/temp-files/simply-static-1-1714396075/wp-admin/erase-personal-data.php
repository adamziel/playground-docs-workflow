...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Erase Personal Data &lsaquo; My WordPress Website &#8212; WordPress</title>
...
var ajaxurl = '/wp-admin/admin-ajax.php',
	...
	typenow = '',
	adminpage = 'erase-personal-data-php',
	thousandsSeparator = ',',
	decimalPoint = '.',
	isRtl = 0;</script>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396126","secure":""};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/erase-personal-data.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js erase-personal-data-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<li class="current"><a href="/wp-admin/erase-personal-data.php" class="current" aria-current="page">Erase Personal Data</a></li>
					...
					<div class="contextual-help-tabs">
						<ul>
							...
							<li id="tab-link-default-data">
								<a href="#tab-panel-default-data" aria-controls="tab-panel-default-data">
									Default Data								</a>
							</li>
							
							<li id="tab-link-plugin-data">
								<a href="#tab-panel-plugin-data" aria-controls="tab-panel-plugin-data">
									Plugin Data								</a>
							</li>
													</ul>
					</div>
...
<p><a href="https://wordpress.org/documentation/article/tools-erase-personal-data-screen/">Documentation on Erase Personal Data</a></p>
...
<p><strong>Note: As this tool only gathers data from WordPress and participating plugins, you may need to do more to comply with erasure requests. For example, you are also responsible for ensuring that data collected by or stored with the 3rd party services your organization uses gets deleted.</strong></p>							</div>
							
							<div id="tab-panel-default-data" class="help-tab-content">
								<p>WordPress collects (but <em>never</em> publishes) a limited amount of data from logged-in users but then deletes it or anonymizes it. That data can include:</p>
<p><strong>Profile Information</strong> &mdash; user email address, username, display name, nickname, first name, last name, description/bio, and registration date.</p>
<p><strong>Community Events Location</strong> &mdash; The IP Address of the user which is used for the Upcoming Community Events shown in the dashboard widget.</p>
<p><strong>Session Tokens</strong> &mdash; User login information, IP Addresses, Expiration Date, User Agent (Browser/OS), and Last Login.</p>
<p><strong>Comments</strong> &mdash; WordPress does not delete comments. The software does anonymize (but, again, <em>never</em> publishes) the associated Email Address, IP Address, and User Agent (Browser/OS).</p>
<p><strong>Media</strong> &mdash; A list of URLs for all media file uploads made by the user.</p>							</div>
							
							<div id="tab-panel-plugin-data" class="help-tab-content">
...
<p>If you are a plugin author, you can <a href="https://developer.wordpress.org/plugins/privacy/adding-the-personal-data-eraser-to-your-plugin/" target="_blank">learn more about how to add support for the Personal Data Eraser to a plugin here</a>.</p>
<p>If you are not sure, check the plugin documentation or contact the plugin author to see if the plugin collects data and if it supports the Data Eraser tool. This information may be available in the <a href="/wp-admin/options-privacy.php?tab=policyguide">Privacy Policy Guide</a>.</p>							</div>
												</div>
				</div>
			</div>
...
<form id="adv-settings" method="post">
		...
		<label><input class="hide-column-tog" name="email-hide" type="checkbox" id="email-hide" value="email" checked>Requester</label>
<label><input class="hide-column-tog" name="status-hide" type="checkbox" id="status-hide" value="status" checked>Status</label>
<label><input class="hide-column-tog" name="created_timestamp-hide" type="checkbox" id="created_timestamp-hide" value="created_timestamp" checked>Requested</label>
<label><input class="hide-column-tog" name="next_steps-hide" type="checkbox" id="next_steps-hide" value="next_steps" checked>Next steps</label>
		</fieldset>
				<fieldset class="screen-options">
		<legend>Pagination</legend>
							<label for="remove_personal_data_requests_per_page">Number of items per page:</label>
				<input type="number" step="1" min="1" max="999" class="screen-per-page" name="wp_screen_options[value]" id="remove_personal_data_requests_per_page" value="20">
							<input type="hidden" name="wp_screen_options[option]" value="remove_personal_data_requests_per_page">
		</fieldset>
...
<div class="wrap nosubsub">
	...
	<form action="http://127.0.0.1:9400/wp-admin/erase-personal-data.php" method="post" class="wp-privacy-request-form">
		...
		<div class="wp-privacy-request-form-field">
			...
			<p class="submit">
				<input type="submit" name="submit" id="submit" class="button" value="Send Request">			</p>
		</div>
		<input type="hidden" id="_wpnonce" name="_wpnonce" value="74c1080b34"><input type="hidden" name="_wp_http_referer" value="/wp-admin/erase-personal-data.php?simply_static_page=79">		<input type="hidden" name="action" value="add_remove_personal_data_request">
		<input type="hidden" name="type_of_action" value="remove_personal_data">
	</form>
	<hr>

	<h2 class="screen-reader-text">Filter erase personal data list</h2>
<ul class="subsubsub">
	<li class="all"><a href="/wp-admin/erase-personal-data.php" class="current" aria-current="page">All <span class="count">(0)</span></a></li>
</ul>
	...
	<form method="post">
		<input type="hidden" id="_wpnonce" name="_wpnonce" value="d052b058e9"><input type="hidden" name="_wp_http_referer" value="/wp-admin/erase-personal-data.php?simply_static_page=79">	<div class="tablenav top">
...
<a class="next-page button" href="/wp-admin/erase-personal-data.php#038;paged=0"><span class="screen-reader-text">Next page</span><span aria-hidden="true">&rsaquo;</span></a>
<a class="last-page button" href="/wp-admin/erase-personal-data.php#038;paged=0"><span class="screen-reader-text">Last page</span><span aria-hidden="true">&raquo;</span></a></span>
</div>
		<br class="clear">
	</div>
		<h2 class="screen-reader-text">Erase personal data list</h2>
<table class="wp-list-table widefat fixed striped table-view-list privacy_requests">
			<thead>
	<tr>
...
<th scope="col" id="email" class="manage-column column-email column-primary sortable desc"><a href="/wp-admin/erase-personal-data.php#038;orderby=requester&#038;order=asc"><span>Requester</span><span class="sorting-indicators"><span class="sorting-indicator asc" aria-hidden="true"></span><span class="sorting-indicator desc" aria-hidden="true"></span></span> <span class="screen-reader-text">Sort ascending.</span></a></th>
<th scope="col" id="status" class="manage-column column-status">Status</th>
<th scope="col" id="created_timestamp" class="manage-column column-created_timestamp sortable desc"><a href="/wp-admin/erase-personal-data.php#038;orderby=requested&#038;order=asc"><span>Requested</span><span class="sorting-indicators"><span class="sorting-indicator asc" aria-hidden="true"></span><span class="sorting-indicator desc" aria-hidden="true"></span></span> <span class="screen-reader-text">Sort ascending.</span></a></th>
<th scope="col" id="next_steps" class="manage-column column-next_steps">Next steps</th>	</tr>
	</thead>
...
<th scope="col" class="manage-column column-email column-primary sortable desc"><a href="/wp-admin/erase-personal-data.php#038;orderby=requester&#038;order=asc"><span>Requester</span><span class="sorting-indicators"><span class="sorting-indicator asc" aria-hidden="true"></span><span class="sorting-indicator desc" aria-hidden="true"></span></span> <span class="screen-reader-text">Sort ascending.</span></a></th>
<th scope="col" class="manage-column column-status">Status</th>
<th scope="col" class="manage-column column-created_timestamp sortable desc"><a href="/wp-admin/erase-personal-data.php#038;orderby=requested&#038;order=asc"><span>Requested</span><span class="sorting-indicators"><span class="sorting-indicator asc" aria-hidden="true"></span><span class="sorting-indicator desc" aria-hidden="true"></span></span> <span class="screen-reader-text">Sort ascending.</span></a></th>
<th scope="col" class="manage-column column-next_steps">Next steps</th>	</tr>
	</tfoot>
...
<script src="/wp-admin/js/privacy-tools.min.js?ver=6.5.2" id="privacy-tools-js"></script>
