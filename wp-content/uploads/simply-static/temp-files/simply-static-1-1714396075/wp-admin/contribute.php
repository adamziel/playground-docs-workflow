...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Get Involved &lsaquo; My WordPress Website &#8212; WordPress</title>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396142","secure":""};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/contribute.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js contribute-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<div id="wpbody-content">
	...
	<nav class="about__header-navigation nav-tab-wrapper wp-clearfix" aria-label="Secondary menu">
		<a href="/wp-admin/about.php" class="nav-tab">What&#8217;s New</a>
		<a href="/wp-admin/credits.php" class="nav-tab">Credits</a>
		<a href="/wp-admin/freedoms.php" class="nav-tab">Freedoms</a>
		<a href="/wp-admin/privacy.php" class="nav-tab">Privacy</a>
		<a href="/wp-admin/contribute.php" class="nav-tab nav-tab-active" aria-current="page">Get Involved</a>
	</nav>

	<div class="about__section has-2-columns is-wider-right">
		<div class="column">
			<img src="/wp-admin/images/contribute-main.svg?ver=6.5" alt="" width="290" height="290">
		</div>
	...
	<div class="about__section has-2-columns is-wider-left">
		<div class="column is-vertically-aligned-center">
			...
			<ul>
				<li>
<strong>Share</strong> your knowledge in the WordPress support forums.</li>
				<li>
<strong>Write</strong> or improve documentation for WordPress.</li>
				<li>
<strong>Translate</strong> WordPress into your local language.</li>
				<li>
<strong>Create</strong> and improve WordPress educational materials.</li>
				<li>
<strong>Promote</strong> the WordPress project to your community.</li>
				<li>
<strong>Curate</strong> submissions or take photos for the Photo Directory.</li>
				<li>
<strong>Organize</strong> or participate in local Meetups and WordCamps.</li>
				<li>
<strong>Lend</strong> your creative imagination to the WordPress UI design.</li>
				<li>
<strong>Edit</strong> videos and add captions to WordPress.tv.</li>
				<li>
<strong>Explore</strong> ways to reduce the environmental impact of websites.</li>
			</ul>
		</div>
		<div class="column">
			<img src="/wp-admin/images/contribute-no-code.svg?ver=6.5" alt="" width="290" height="290">
		</div>
	</div>
	<div class="about__section has-2-columns is-wider-right">
		<div class="column">
			<img src="/wp-admin/images/contribute-code.svg?ver=6.5" alt="" width="290" height="290">
		</div>
		<div class="column is-vertically-aligned-center">
			...
			<ul>
				<li>
<strong>Find</strong> and report bugs in the WordPress core software.</li>
				<li>
<strong>Test</strong> new releases and proposed features for the Block Editor.</li>
				<li>
<strong>Write</strong> and submit patches to fix bugs or help build new features.</li>
				<li>
<strong>Contribute</strong> to the code, improve the UX, and test the WordPress app.</li>
			</ul>
