...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Credits &lsaquo; My WordPress Website &#8212; WordPress</title>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/credits.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js credits-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<div id="wpbody-content">
	...
	<div class="about__header">
		...
		<div class="about__header-text">
			Created by a worldwide team of passionate individuals		</div>
	</div>
	...
	<nav class="about__header-navigation nav-tab-wrapper wp-clearfix" aria-label="Secondary menu">
		...
		<a href="/wp-admin/credits.php" class="nav-tab nav-tab-active" aria-current="page">Credits</a>
	...
	<div class="about__section has-1-column has-gutters">
		<div class="column aligncenter">
			...
			<p>
				WordPress is created by a <a href="https://wordpress.org/about/">worldwide team</a> of passionate individuals.				<br>
				<a href="https://make.wordpress.org/contribute/">Get involved in WordPress.</a>
			</p>
