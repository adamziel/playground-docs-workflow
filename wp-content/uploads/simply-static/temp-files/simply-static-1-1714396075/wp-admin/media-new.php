...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Upload New Media &lsaquo; My WordPress Website &#8212; WordPress</title>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/media-new.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js media-new-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<li><a href="/wp-admin/update-core.php">Updates <span class="update-plugins count-0"><span class="update-count">0</span></span></a></li>
	...
	<li class="wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-icon-media menu-top-first" id="menu-media">
	<a href="/wp-admin/upload.php" class="wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-icon-media menu-top-first"><div class="wp-menu-arrow"><div></div></div>
...
<li class="current"><a href="/wp-admin/media-new.php" class="current" aria-current="page">Add New Media File</a></li>
</ul>
</li>
...
<p><a href="https://wordpress.org/documentation/article/media-add-new-screen/">Documentation on Uploading Media Files</a></p>
...
<ul>
<li>
<strong>Drag and drop</strong> your files into the area below. Multiple files are allowed.</li>
<li>Clicking <strong>Select Files</strong> opens a navigation window showing you files in your operating system. Selecting <strong>Open</strong> after clicking on the file you want activates a progress bar on the uploader screen.</li>
<li>Revert to the <strong>Browser Uploader</strong> by clicking the link below the drag and drop box.</li>
</ul>							</div>
												</div>
				</div>
			</div>
	...
	<form enctype="multipart/form-data" method="post" action="http://127.0.0.1:9400/wp-admin/media-new.php" class="media-upload-form type-form validate" id="file-form">

		<div id="media-upload-notice">
		</div>
	<div id="media-upload-error">
		</div>
		<script type="text/javascript">var resize_height = 1024, resize_width = 1024,
	wpUploaderInit = {"browse_button":"plupload-browse-button","container":"plupload-upload-ui","drop_element":"drag-drop-area","file_data_name":"async-upload","url":"\/wp-admin\/async-upload.php","filters":{"max_file_size":"2097152000b"},"multipart_params":{"post_id":0,"_wpnonce":"6c3f1dcfb9","type":"","tab":"","short":"1"},"webp_upload_error":true,"heic_upload_error":true};</script>
	...
	You are using the multi-file uploader. Problems? Try the <a href="/wp-admin/media-new.php?browser-uploader" target="_blank">browser uploader</a> instead.	</p>
		</div>
...
<p class="max-upload-size">
	...
	<script type="text/javascript">var post_id = 0, shortform = 3;</script>
	<input type="hidden" name="post_id" id="post_id" value="0">
	<input type="hidden" id="_wpnonce" name="_wpnonce" value="6c3f1dcfb9"><input type="hidden" name="_wp_http_referer" value="/wp-admin/media-new.php?simply_static_page=66">	<div id="media-items" class="hide-if-no-js"></div>
	</form>
</div>
