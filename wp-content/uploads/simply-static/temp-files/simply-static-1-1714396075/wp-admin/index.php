...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Dashboard &lsaquo; My WordPress Website &#8212; WordPress</title>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396094","secure":""};/* ]]> */
</script>
<script src="/wp-admin/load-scripts.php?c=0&amp;load%5Bchunk_0%5D=jquery-core%2Cjquery-migrate%2Cutils%2Cwp-polyfill-inert%2Cregenerator-runtime%2Cwp-polyfill&amp;ver=6.5.2"></script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/index.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js index-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<ul id="adminmenu">
	...
	<a href="/wp-admin/index.php" class="wp-first-item wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-top-first menu-icon-dashboard menu-top-last"><div class="wp-menu-arrow"><div></div></div>
...
<li class="wp-first-item current"><a href="/wp-admin/index.php" class="wp-first-item current" aria-current="page">Home</a></li>
...
<li><a href="/wp-admin/plugin-install.php">Add New Plugin</a></li>
	...
	<a href="/wp-admin/tools.php" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-tools" aria-haspopup="true"><div class="wp-menu-arrow"><div></div></div>
...
<p><a href="https://wordpress.org/documentation/article/dashboard-screen/">Documentation on Dashboard</a></p>
<p><a href="https://wordpress.org/support/forums/">Support forums</a></p>
<p><a href="https://wordpress.org/documentation/wordpress-version/version-6-5-2/">Version 6.5.2</a></p>					</div>
					
					<div class="contextual-help-tabs-wrap">
						
							<div id="tab-panel-overview" class="help-tab-content active">
								<p>Welcome to your WordPress Dashboard!</p>
<p>The Dashboard is the first place you will come to every time you log into your site. It is where you will find all your WordPress tools. If you need help, just click the &#8220;Help&#8221; tab above the screen title.</p>							</div>
...
<p><strong>Box Controls</strong> &mdash; Click the title bar of the box to expand or collapse it. Some boxes added by plugins may have configurable content, and will show a &#8220;Configure&#8221; link in the title bar if you hover over it.</p>							</div>
...
<p><strong>Site Health Status</strong> &mdash; Informs you of any potential issues that should be addressed to improve the performance or security of your website.</p>
...
<p><strong>Quick Draft</strong> &mdash; Allows you to create a new post and save it as a draft. Also displays links to the 3 most recent draft posts you've started.</p>
<p><strong>WordPress Events and News</strong> &mdash; Upcoming events near you as well as the latest news from the official WordPress project and the <a href="https://planet.wordpress.org/">WordPress Planet</a>.</p>							</div>
												</div>
				</div>
			</div>
...
<div class="wrap">
	...
	<div id="welcome-panel" class="welcome-panel">
		<input type="hidden" id="welcomepanelnonce" name="welcomepanelnonce" value="543f99262a">		<a class="welcome-panel-close" href="/wp-admin/?welcome=0" aria-label="Dismiss the welcome panel">Dismiss</a>
    ...
    <clippath id="a">
      <path fill="#fff" d="M0 0h1232v240H0z"></path>
		...
		<p>
			...
			Learn more about the 6.5.2 version.			</a>
		</p>
	</div>
	<div class="welcome-panel-column-container">
		<div class="welcome-panel-column">
			...
			<div class="welcome-panel-column-content">
				...
				<a href="/wp-admin/post-new.php?post_type=page">Add a new page</a>
			</div>
		</div>
		<div class="welcome-panel-column">
			<svg width="48" height="48" viewbox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
			...
			<div class="welcome-panel-column-content">
							<h3>Customize your entire site with block themes</h3>
				<p>Design everything on your site &#8212; from the header down to the footer, all using blocks and patterns.</p>
				<a href="/wp-admin/site-editor.php">Open site editor</a>
						</div>
		</div>
		<div class="welcome-panel-column">
			<svg width="48" height="48" viewbox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
			...
			<div class="welcome-panel-column-content">
							<h3>Switch up your site&#8217;s look & feel with Styles</h3>
				<p>Tweak your site, or give it a whole new look! Get creative &#8212; how about a new color palette or font?</p>
				<a href="/wp-admin/site-editor.php?path=%2Fwp_global_styles">Edit styles</a>
						</div>
		</div>
	</div>
	</div>
	...
	<div class="health-check-widget">
		<div class="health-check-widget-title-section site-health-progress-wrapper loading hide-if-no-js">
			...
			<div class="site-health-progress-label">
									No information yet&hellip;							</div>
		</div>

		<div class="site-health-details">
							<p>
					Site health checks will automatically run periodically to gather information about your site. You can also <a href="/wp-admin/site-health.php">visit the Site Health screen</a> to gather information about your site now.				</p>
...
<div class="inside">
	<div class="main">
	<ul>
	<li class="post-count"><a href="/wp-admin/edit.php?post_type=post">1 Post</a></li>
<li class="page-count"><a href="/wp-admin/edit.php?post_type=page">10 Pages</a></li>		<li class="comment-count">
			<a href="/wp-admin/edit-comments.php">1 Comment</a>
		</li>
				<li class="comment-mod-count hidden">
			<a href="/wp-admin/edit-comments.php?comment_status=moderated" class="comments-in-moderation-text">0 Comments in moderation</a>
		</li>
			</ul>
	<p id="wp-version-message"><span id="wp-version">WordPress 6.5.2 running <a href="/wp-admin/themes.php">Playground Docs</a> theme.</span></p>	</div>
	</div>
</div>
...
<ul><li>
<span>Apr 22nd, 11:37 pm</span> <a href="/wp-admin/post.php?post=1&amp;action=edit" aria-label="Edit &#8220;Hello world!&#8221;">Hello world!</a>
</li></ul>
</div>
...
<ul id="the-comment-list" data-wp-lists="list:comment">
		<li id="comment-1" class="comment even thread-even depth-1 comment-item approved">
			...
			<img alt="" src="http://1.gravatar.com/avatar/d7a973c7dab26985da5f961be7b74480?s=50&#038;d=mm&#038;r=g" srcset="http://1.gravatar.com/avatar/d7a973c7dab26985da5f961be7b74480?s=100&#038;d=mm&#038;r=g 2x" class="avatar avatar-50 photo" height="50" width="50" loading="lazy" decoding="async">
			
			<div class="dashboard-comment-wrap has-row-actions  has-avatar">
			<p class="comment-meta">
				From <cite class="comment-author"><a href="https://wordpress.org/" class="url" rel="ugc external nofollow">A WordPress Commenter</a></cite> on <a href="/hello-world/">Hello world!</a> <span class="approve">[Pending]</span>			</p>
						...
						<p class="row-actions"><span class="approve"><a href="/wp-admin/comment.php?action=approvecomment#038;p=1&#038;c=1&#038;_wpnonce=8488242e4f" data-wp-lists="dim:the-comment-list:comment-1:unapproved:e7e7d3:e7e7d3:new=approved" class="vim-a aria-button-if-js" aria-label="Approve this comment">Approve</a></span><span class="unapprove"><a href="/wp-admin/comment.php?action=unapprovecomment#038;p=1&#038;c=1&#038;_wpnonce=8488242e4f" data-wp-lists="dim:the-comment-list:comment-1:unapproved:e7e7d3:e7e7d3:new=unapproved" class="vim-u aria-button-if-js" aria-label="Unapprove this comment">Unapprove</a></span><span class="reply hide-if-no-js"> | <button type="button" onclick="window.commentReply && commentReply.open('1','1');" class="vim-r button-link hide-if-no-js" aria-label="Reply to this comment">Reply</button></span><span class="edit"> | <a href="/wp-admin/comment.php?action=editcomment&amp;c=1" aria-label="Edit this comment">Edit</a></span><span class="spam"> | <a href="/wp-admin/comment.php?action=spamcomment#038;p=1&#038;c=1&#038;_wpnonce=d292b9ae98" data-wp-lists="delete:the-comment-list:comment-1::spam=1" class="vim-s vim-destructive aria-button-if-js" aria-label="Mark this comment as spam">Spam</a></span><span class="trash"> | <a href="/wp-admin/comment.php?action=trashcomment#038;p=1&#038;c=1&#038;_wpnonce=d292b9ae98" data-wp-lists="delete:the-comment-list:comment-1::trash=1" class="delete vim-d vim-destructive aria-button-if-js" aria-label="Move this comment to the Trash">Trash</a></span><span class="view"> | <a class="comment-link" href="/hello-world/#comment-1" aria-label="View this comment">View</a></span></p>
						</div>
		</li>
	</ul>
...
<ul class="subsubsub">
	<li class="all">
<a href="/wp-admin/edit-comments.php?comment_status=all">All <span class="count">(<span class="all-count">1</span>)</span></a> |</li>
	<li class="mine">
<a href="/wp-admin/edit-comments.php?comment_status=mine#038;user_id=1">Mine <span class="count">(<span class="mine-count">0</span>)</span></a> |</li>
	<li class="moderated">
<a href="/wp-admin/edit-comments.php?comment_status=moderated">Pending <span class="count">(<span class="pending-count">0</span>)</span></a> |</li>
	<li class="approved">
<a href="/wp-admin/edit-comments.php?comment_status=approved">Approved <span class="count">(<span class="approved-count">1</span>)</span></a> |</li>
	<li class="spam">
<a href="/wp-admin/edit-comments.php?comment_status=spam">Spam <span class="count">(<span class="spam-count">0</span>)</span></a> |</li>
...
<link rel="stylesheet" id="editor-buttons-css" href="/wp-includes/css/editor.min.css?ver=6.5.2" media="all">
<div id="wp-replycontent-editor-container" class="wp-editor-container">
<div id="qt_replycontent_toolbar" class="quicktags-toolbar hide-if-no-js"></div>
<textarea class="wp-editor-area" rows="20" cols="40" name="replycontent" id="replycontent"></textarea>
	...
	<input type="hidden" id="_ajax_nonce-replyto-comment" name="_ajax_nonce-replyto-comment" value="c41007b6c7"><input type="hidden" id="_wp_unfiltered_html_comment" name="_wp_unfiltered_html_comment" value="477a1ec8a2">	</fieldset>
	</div></div>
	</form>
...
<div class="postbox-header">
<h2 class="hndle">
<span class="hide-if-no-js">Quick Draft</span> <span class="hide-if-js">Your Recent Drafts</span>
</h2>
<div class="handle-actions hide-if-no-js">
<button type="button" class="handle-order-higher" aria-disabled="false" aria-describedby="dashboard_quick_press-handle-order-higher-description"><span class="screen-reader-text">Move up</span><span class="order-higher-indicator" aria-hidden="true"></span></button><span class="hidden" id="dashboard_quick_press-handle-order-higher-description">Move <span class="hide-if-no-js">Quick Draft</span> <span class="hide-if-js">Your Recent Drafts</span> box up</span><button type="button" class="handle-order-lower" aria-disabled="false" aria-describedby="dashboard_quick_press-handle-order-lower-description"><span class="screen-reader-text">Move down</span><span class="order-lower-indicator" aria-hidden="true"></span></button><span class="hidden" id="dashboard_quick_press-handle-order-lower-description">Move <span class="hide-if-no-js">Quick Draft</span> <span class="hide-if-js">Your Recent Drafts</span> box down</span><button type="button" class="handlediv" aria-expanded="true"><span class="screen-reader-text">Toggle panel: <span class="hide-if-no-js">Quick Draft</span> <span class="hide-if-js">Your Recent Drafts</span></span><span class="toggle-indicator" aria-hidden="true"></span></button>
</div>
</div>
<div class="inside">

	<form name="post" action="http://127.0.0.1:9400/wp-admin/post.php" method="post" id="quick-press" class="initial-form hide-if-no-js">
		...
		<p class="submit">
			...
			<input type="hidden" id="_wpnonce" name="_wpnonce" value="b5792d4810"><input type="hidden" name="_wp_http_referer" value="/wp-admin/index.php?simply_static_page=63">			<input type="submit" name="save" id="save-post" class="button button-primary" value="Save Draft">			<br class="clear">
		</p>
...
<div class="handle-actions hide-if-no-js">
<button type="button" class="handle-order-higher" aria-disabled="false" aria-describedby="dashboard_primary-handle-order-higher-description"><span class="screen-reader-text">Move up</span><span class="order-higher-indicator" aria-hidden="true"></span></button><span class="hidden" id="dashboard_primary-handle-order-higher-description">Move WordPress Events and News box up</span><button type="button" class="handle-order-lower" aria-disabled="false" aria-describedby="dashboard_primary-handle-order-lower-description"><span class="screen-reader-text">Move down</span><span class="order-lower-indicator" aria-hidden="true"></span></button><span class="hidden" id="dashboard_primary-handle-order-lower-description">Move WordPress Events and News box down</span><button type="button" class="handlediv" aria-expanded="true"><span class="screen-reader-text">Toggle panel: WordPress Events and News</span><span class="toggle-indicator" aria-hidden="true"></span></button>
</div>
</div>
<div class="inside">
<div class="notice notice-error community-events-errors inline hide-if-js">
<p class="hide-if-js">This widget requires JavaScript.</p>
<p class="community-events-error-occurred" aria-hidden="true">An error occurred. Please try again.</p>
<p class="community-events-could-not-locate" aria-hidden="true"></p>
</div>	<div id="community-events" class="community-events" aria-hidden="true">
		<div class="activity-block">
			<p>
				...
				<button class="button-link community-events-toggle-location" aria-expanded="false">
					...
					<span class="community-events-location-edit">Select location</span>
				</button>
			</p>

			<form class="community-events-form" aria-hidden="true" action="http://127.0.0.1:9400/wp-admin/admin-ajax.php" method="post">
	...
	<div class="wordpress-news hide-if-no-js">
		<p class="widget-loading hide-if-no-js">Loading&hellip;</p>
<div class="notice notice-error inline hide-if-js"><p>This widget requires JavaScript.</p></div>	</div>
	...
	<input type="hidden" id="closedpostboxesnonce" name="closedpostboxesnonce" value="61de026f84"><input type="hidden" id="meta-box-order-nonce" name="meta-box-order-nonce" value="cd5c8bae2f">	</div>
...
<!-- wrap -->
	...
	<script id="tmpl-community-events-could-not-locate" type="text/template">
		<em>{{data.unknownCity}}<\/em> could not be located. Please try another nearby city. For example: Kansas City; Springfield; Portland.	</script>
	...
	<script id="tmpl-community-events-event-list" type="text/template">
		...
		<# if ( data.events.length <= 2 ) { #>
			<li class="event-none">
				Want more events? <a href="https://make.wordpress.org/community/organize-event-landing-page/">Help organize the next one<\/a>!			<\/li>
		<# } #>
	...
	<script id="tmpl-community-events-no-upcoming-events" type="text/template">
		<li class="event-none">
			<# if ( data.location.description ) { #>
				There are no events scheduled near {{ data.location.description }} at the moment. Would you like to <a href="https://make.wordpress.org/community/handbook/meetup-organizer/welcome/">organize a WordPress event<\/a>?
			<# } else { #>
				There are no events scheduled near you at the moment. Would you like to <a href="https://make.wordpress.org/community/handbook/meetup-organizer/welcome/">organize a WordPress event<\/a>?			<# } #>
		<\/li>
	</script>
...
<script id="wp-api-request-js-extra">var wpApiSettings = {"root":"\/wp-json\/","nonce":"f97ec4f620","versionString":"wp\/v2\/"};</script>
<script src="/wp-includes/js/api-request.min.js?ver=6.5.2" id="wp-api-request-js"></script>
<script id="site-health-js-extra">var SiteHealth = {"screen":"dashboard","nonce":{"site_status":"ff32099518","site_status_result":"b509b2bbfa"},"site_status":{"direct":[],"async":[],"issues":{"good":0,"recommended":0,"critical":0}}};</script>
<script src="/wp-admin/js/site-health.min.js?ver=6.5.2" id="site-health-js"></script>
<script id="wp-ajax-response-js-extra">var wpAjax = {"noPerm":"Sorry, you are not allowed to do that.","broken":"Something went wrong."};</script>
<script src="/wp-includes/js/wp-ajax-response.min.js?ver=6.5.2" id="wp-ajax-response-js"></script>
<script src="/wp-includes/js/jquery/jquery.color.min.js?ver=2.2.0" id="jquery-color-js"></script>
<script src="/wp-includes/js/wp-lists.min.js?ver=6.5.2" id="wp-lists-js"></script>
...
<script src="/wp-includes/js/quicktags.min.js?ver=6.5.2" id="quicktags-js"></script>
<script src="/wp-includes/js/jquery/jquery.query.js?ver=2.2.3" id="jquery-query-js"></script>
<script id="admin-comments-js-extra">var adminCommentsSettings = {"hotkeys_highlight_first":"","hotkeys_highlight_last":""};</script>
<script src="/wp-admin/js/edit-comments.min.js?ver=6.5.2" id="admin-comments-js"></script>
...
<script src="/wp-admin/js/postbox.min.js?ver=6.5.2" id="postbox-js"></script>
...
<script src="/wp-content/plugins/gutenberg/build/deprecated/index.min.js?ver=5f56b9106e825b0b4ab3" id="wp-deprecated-js"></script>
<script src="/wp-content/plugins/gutenberg/build/date/index.min.js?ver=5fc751fe4ae7f26be56d" id="wp-date-js"></script>
<script id="wp-date-js-after">wp.date.setSettings( {"l10n":{"locale":"en_US","months":["January","February","March","April","May","June","July","August","September","October","November","December"],"monthsShort":["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"weekdays":["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],"weekdaysShort":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"meridiem":{"am":"am","pm":"pm","AM":"AM","PM":"PM"},"relative":{"future":"%s from now","past":"%s ago","s":"a second","ss":"%d seconds","m":"a minute","mm":"%d minutes","h":"an hour","hh":"%d hours","d":"a day","dd":"%d days","M":"a month","MM":"%d months","y":"a year","yy":"%d years"},"startOfWeek":1},"formats":{"time":"g:i a","date":"F j, Y","datetime":"F j, Y g:i a","datetimeAbbreviated":"M j, Y g:i a"},"timezone":{"offset":0,"offsetFormatted":"0","string":"","abbr":""}} );</script>
<script id="dashboard-js-extra">var communityEventsData = {"nonce":"de6f0f044f","cache":"","time_format":"g:i a"};</script>
<script src="/wp-admin/js/dashboard.min.js?ver=6.5.2" id="dashboard-js"></script>
...
<script src="/wp-admin/js/plugin-install.min.js?ver=6.5.2" id="plugin-install-js"></script>
<script src="/wp-includes/js/wp-sanitize.min.js?ver=6.5.2" id="wp-sanitize-js"></script>
<script id="updates-js-extra">var _wpUpdatesSettings = {"ajax_nonce":"9cc44cfbbb"};</script>
<script src="/wp-admin/js/updates.min.js?ver=6.5.2" id="updates-js"></script>
<script src="/wp-includes/js/shortcode.min.js?ver=6.5.2" id="shortcode-js"></script>
<script src="/wp-admin/js/media-upload.min.js?ver=6.5.2" id="media-upload-js"></script>
...
<script src="/wp-includes/js/wplink.min.js?ver=6.5.2" id="wplink-js"></script>
<script src="/wp-includes/js/jquery/ui/menu.min.js?ver=1.13.2" id="jquery-ui-menu-js"></script>
<script src="/wp-includes/js/jquery/ui/autocomplete.min.js?ver=1.13.2" id="jquery-ui-autocomplete-js"></script>
		...
		<input type="hidden" id="_ajax_linking_nonce" name="_ajax_linking_nonce" value="a7a39855af">		<h1 id="link-modal-title">Insert/edit link</h1>
