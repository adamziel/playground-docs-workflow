...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Add New User &lsaquo; My WordPress Website &#8212; WordPress</title>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396145","secure":""};var _zxcvbnSettings = {"src":"\/wp-includes\/js\/zxcvbn.min.js"};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/user-new.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js user-new-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
					...
					<div class="contextual-help-tabs">
						<ul>
							...
							<li id="tab-link-user-roles">
								<a href="#tab-panel-user-roles" aria-controls="tab-panel-user-roles">
									User Roles								</a>
							</li>
													</ul>
					</div>
...
<p><a href="https://wordpress.org/documentation/article/users-add-new-screen/">Documentation on Adding New Users</a></p>
...
<p>Remember to click the Add New User button at the bottom of this screen when you are finished.</p>							</div>
							
							<div id="tab-panel-user-roles" class="help-tab-content">
...
<input name="action" type="hidden" value="createuser">
	<input type="hidden" id="_wpnonce_create-user" name="_wpnonce_create-user" value="e1723a0897"><input type="hidden" name="_wp_http_referer" value="/wp-admin/user-new.php?simply_static_page=92">	<table class="form-table" role="presentation">
	...
	<tr class="form-field">
		...
		<td>
			...
			<div class="wp-pwd">
					...
					<input type="password" name="pass1" id="pass1" class="regular-text" autocomplete="new-password" spellcheck="false" data-reveal="1" data-pw="^#nVfmdY59bBr^7YNDHpx6be" aria-describedby="pass-strength-result">
