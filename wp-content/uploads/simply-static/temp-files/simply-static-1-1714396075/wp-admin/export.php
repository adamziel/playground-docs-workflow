...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Export &lsaquo; My WordPress Website &#8212; WordPress</title>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396123","secure":""};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/export.php">
...
<body class="wp-admin wp-core-ui no-js export-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<li class="current"><a href="/wp-admin/export.php" class="current" aria-current="page">Export</a></li>
...
<p><a href="https://wordpress.org/documentation/article/tools-export-screen/">Documentation on Export</a></p>
...
<p>Once generated, your WXR file can be imported by another WordPress site or by another blogging platform able to access this format.</p>							</div>
												</div>
				</div>
			</div>
				</div>
...
<legend class="screen-reader-text">
	Content to export</legend>
<input type="hidden" name="download" value="true">
<p><label><input type="radio" name="content" value="all" checked aria-describedby="all-content-desc"> All content</label></p>
...
<ul id="post-filters" class="export-filters">
	<li>
		<label><span class="label-responsive">Categories:</span>
	...
	<li>
		...
		<legend class="screen-reader-text">
			Date range:		</legend>
		<label for="post-start-date" class="label-responsive">Start date:</label>
		<select name="post_start_date" id="post-start-date">
			<option value="0">&mdash; Select &mdash;</option>
			<option value="2024-04">April 2024</option>		</select>
		<label for="post-end-date" class="label-responsive">End date:</label>
	...
	<li>
		<label for="post-status" class="label-responsive">Status:</label>
...
<ul id="page-filters" class="export-filters">
	...
	<li>
		...
		<legend class="screen-reader-text">
			Date range:		</legend>
		<label for="page-start-date" class="label-responsive">Start date:</label>
		<select name="page_start_date" id="page-start-date">
			<option value="0">&mdash; Select &mdash;</option>
			<option value="2024-04">April 2024</option>		</select>
		<label for="page-end-date" class="label-responsive">End date:</label>
	...
	<li>
		<label for="page-status" class="label-responsive">Status:</label>
...
<ul id="attachment-filters" class="export-filters">
	<li>
		...
		<legend class="screen-reader-text">
			Date range:		</legend>
		<label for="attachment-start-date" class="label-responsive">Start date:</label>
		<select name="attachment_start_date" id="attachment-start-date">
			<option value="0">&mdash; Select &mdash;</option>
			<option value="2024-04">April 2024</option>		</select>
		<label for="attachment-end-date" class="label-responsive">End date:</label>
