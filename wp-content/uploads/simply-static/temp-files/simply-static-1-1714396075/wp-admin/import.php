...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Import &lsaquo; My WordPress Website &#8212; WordPress</title>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396122","secure":""};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/import.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js import-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<li class="current"><a href="/wp-admin/import.php" class="current" aria-current="page">Import</a></li>
...
<p><a href="https://wordpress.org/documentation/article/tools-import-screen/">Documentation on Import</a></p>
<p><a href="https://wordpress.org/support/forums">Support</a></p>					</div>
...
<p>In previous versions of WordPress, all importers were built-in. They have been turned into plugins since most people only use them once or infrequently.</p>							</div>
												</div>
				</div>
			</div>
				</div>
...
<table class="widefat importers striped">
			...
			<tr class="importer-item">
				<td class="import-system">
					<span class="importer-title">Blogger</span>
					<span class="importer-action"><a href="/wp-admin/update.php?action=install-plugin#038;plugin=blogger-importer&#038;from=import&#038;_wpnonce=bfe91738b0" class="install-now" data-slug="blogger-importer" data-name="Blogger" aria-label="Install Blogger now">Install Now</a> | <a href="/wp-admin/plugin-install.php?tab=plugin-information#038;plugin=blogger-importer&#038;from=import&#038;TB_iframe=true&#038;width=600&#038;height=550" class="thickbox open-plugin-details-modal" aria-label="More information about Blogger">Details</a></span>
				</td>
				<td class="desc">
					<span class="importer-desc">Import posts, comments, and users from a Blogger blog.</span>
				</td>
			</tr>
			<tr class="importer-item">
				<td class="import-system">
					<span class="importer-title">Categories and Tags Converter</span>
					<span class="importer-action"><a href="/wp-admin/update.php?action=install-plugin#038;plugin=wpcat2tag-importer&#038;from=import&#038;_wpnonce=f3d357ad2b" class="install-now" data-slug="wpcat2tag-importer" data-name="Categories and Tags Converter" aria-label="Install Categories and Tags Converter now">Install Now</a> | <a href="/wp-admin/plugin-install.php?tab=plugin-information#038;plugin=wpcat2tag-importer&#038;from=import&#038;TB_iframe=true&#038;width=600&#038;height=550" class="thickbox open-plugin-details-modal" aria-label="More information about Categories and Tags Converter">Details</a></span>
				</td>
				<td class="desc">
			...
			<tr class="importer-item">
				<td class="import-system">
					...
					<span class="importer-action"><a href="/wp-admin/update.php?action=install-plugin#038;plugin=livejournal-importer&#038;from=import&#038;_wpnonce=35ea2ad8fb" class="install-now" data-slug="livejournal-importer" data-name="LiveJournal" aria-label="Install LiveJournal now">Install Now</a> | <a href="/wp-admin/plugin-install.php?tab=plugin-information#038;plugin=livejournal-importer&#038;from=import&#038;TB_iframe=true&#038;width=600&#038;height=550" class="thickbox open-plugin-details-modal" aria-label="More information about LiveJournal">Details</a></span>
				</td>
				<td class="desc">
			...
			<tr class="importer-item">
				<td class="import-system">
					...
					<span class="importer-action"><a href="/wp-admin/update.php?action=install-plugin#038;plugin=movabletype-importer&#038;from=import&#038;_wpnonce=9f9e51694a" class="install-now" data-slug="movabletype-importer" data-name="Movable Type and TypePad" aria-label="Install Movable Type and TypePad now">Install Now</a> | <a href="/wp-admin/plugin-install.php?tab=plugin-information#038;plugin=movabletype-importer&#038;from=import&#038;TB_iframe=true&#038;width=600&#038;height=550" class="thickbox open-plugin-details-modal" aria-label="More information about Movable Type and TypePad">Details</a></span>
				</td>
				<td class="desc">
			...
			<tr class="importer-item">
				<td class="import-system">
					...
					<span class="importer-action"><a href="/wp-admin/update.php?action=install-plugin#038;plugin=rss-importer&#038;from=import&#038;_wpnonce=12b3906104" class="install-now" data-slug="rss-importer" data-name="RSS" aria-label="Install RSS now">Install Now</a> | <a href="/wp-admin/plugin-install.php?tab=plugin-information#038;plugin=rss-importer&#038;from=import&#038;TB_iframe=true&#038;width=600&#038;height=550" class="thickbox open-plugin-details-modal" aria-label="More information about RSS">Details</a></span>
				</td>
				<td class="desc">
			...
			<tr class="importer-item">
				<td class="import-system">
					...
					<span class="importer-action"><a href="/wp-admin/update.php?action=install-plugin#038;plugin=tumblr-importer&#038;from=import&#038;_wpnonce=8cee0bef89" class="install-now" data-slug="tumblr-importer" data-name="Tumblr" aria-label="Install Tumblr now">Install Now</a> | <a href="/wp-admin/plugin-install.php?tab=plugin-information#038;plugin=tumblr-importer&#038;from=import&#038;TB_iframe=true&#038;width=600&#038;height=550" class="thickbox open-plugin-details-modal" aria-label="More information about Tumblr">Details</a></span>
				</td>
				<td class="desc">
			...
			<tr class="importer-item">
				<td class="import-system">
					...
					<span class="importer-action"><a href="/wp-admin/update.php?action=install-plugin#038;plugin=wordpress-importer&#038;from=import&#038;_wpnonce=2759fc28f6" class="install-now" data-slug="wordpress-importer" data-name="WordPress" aria-label="Install WordPress now">Install Now</a> | <a href="/wp-admin/plugin-install.php?tab=plugin-information#038;plugin=wordpress-importer&#038;from=import&#038;TB_iframe=true&#038;width=600&#038;height=550" class="thickbox open-plugin-details-modal" aria-label="More information about WordPress">Details</a></span>
				</td>
				<td class="desc">
	...
	<p>If the importer you need is not listed, <a href="/wp-admin/plugin-install.php?tab=search#038;type=tag&#038;s=importer">search the plugin directory</a> to see if an importer is available.</p>
</div>
