...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Freedoms &lsaquo; My WordPress Website &#8212; WordPress</title>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396153","secure":""};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/freedoms.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js freedoms-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<div id="wpbody-content">
	...
	<div class="about__header">
		<div class="about__header-title">
			<h1>
				The Four Freedoms			</h1>
		</div>

		<div class="about__header-text">
			WordPress is free and open source software		</div>
	</div>
	...
	<nav class="about__header-navigation nav-tab-wrapper wp-clearfix" aria-label="Secondary menu">
		...
		<a href="/wp-admin/freedoms.php" class="nav-tab nav-tab-active" aria-current="page">Freedoms</a>
		<a href="/wp-admin/privacy.php" class="nav-tab">Privacy</a>
		<a href="/wp-admin/contribute.php" class="nav-tab">Get Involved</a>
	</nav>

	<div class="about__section is-feature">
		<p class="about-description">
		WordPress comes with some awesome, worldview-changing rights courtesy of its <a href="https://wordpress.org/about/license/">license</a>, the GPL.		</p>
	</div>

	<div class="about__section has-2-columns">
		<div class="column aligncenter">
			<img class="freedom-image" src="/wp-admin/images/freedom-1.svg?ver=6.5" alt="">
			<h2 class="is-smaller-heading">The 1st Freedom</h2>
			<p>To run the program for any purpose.</p>
		</div>
		<div class="column aligncenter">
			<img class="freedom-image" src="/wp-admin/images/freedom-2.svg?ver=6.5" alt="">
			<h2 class="is-smaller-heading">The 2nd Freedom</h2>
			<p>To study how the program works and change it to make it do what you wish.</p>
		</div>
		<div class="column aligncenter">
			<img class="freedom-image" src="/wp-admin/images/freedom-3.svg?ver=6.5" alt="">
			<h2 class="is-smaller-heading">The 3rd Freedom</h2>
			<p>To redistribute.</p>
		</div>
		<div class="column aligncenter">
			<img class="freedom-image" src="/wp-admin/images/freedom-4.svg?ver=6.5" alt="">
			<h2 class="is-smaller-heading">The 4th Freedom</h2>
	...
	<div class="about__section has-1-column">
		<div class="column">
			<p>
			WordPress grows when people like you tell their friends about it, and the thousands of businesses and services that are built on and around WordPress share that fact with their users. We are flattered every time someone spreads the good word, just make sure to <a href="https://wordpressfoundation.org/trademark-policy/">check out our trademark guidelines</a> first.			</p>

			<p>
			Every plugin and theme in WordPress.org&#8217;s directory is 100% GPL or a similarly free and compatible license, so you can feel safe finding <a href="/wp-admin/plugins.php">plugins</a> and <a href="/wp-admin/themes.php">themes</a> there. If you get a plugin or theme from another source, make sure to <a href="https://wordpress.org/about/license/">ask them if it&#8217;s GPL</a> first. If they do not respect the WordPress license, it is not recommended to use them.			</p>
		</div>
	</div>
