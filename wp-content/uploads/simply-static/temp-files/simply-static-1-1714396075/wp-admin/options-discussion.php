...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Discussion Settings &lsaquo; My WordPress Website &#8212; WordPress</title>
...
var ajaxurl = '/wp-admin/admin-ajax.php',
	...
	typenow = '',
	adminpage = 'options-discussion-php',
	thousandsSeparator = ',',
	decimalPoint = '.',
	isRtl = 0;</script>
<link rel="dns-prefetch" href="//127.0.0.1">
<link rel="stylesheet" href="/wp-admin/load-styles.php?c=0&amp;dir=ltr&amp;load%5Bchunk_0%5D=dashicons%2Cadmin-bar%2Ccommon%2Cforms%2Cadmin-menu%2Cdashboard%2Clist-tables%2Cedit%2Crevisions%2Cmedia%2Cthemes%2Cabout%2Cnav-menus%2Cwp-pointer%2Cwidgets&amp;load%5Bchunk_1%5D=%2Csite-icon%2Cl10n%2Cbuttons%2Cwp-auth-check&amp;ver=6.5.2" media="all">
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396136","secure":""};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/options-discussion.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js options-discussion-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<li><a href="/wp-admin/plugin-editor.php">Plugin File Editor</a></li>
	...
	<a href="/wp-admin/options-general.php" class="wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-icon-settings menu-top-last"><div class="wp-menu-arrow"><div></div></div>
...
<li class="current"><a href="/wp-admin/options-discussion.php" class="current" aria-current="page">Discussion</a></li>
...
<p><a href="https://wordpress.org/documentation/article/settings-discussion-screen/">Documentation on Discussion Settings</a></p>
...
<p>You must click the Save Changes button at the bottom of the screen for new settings to take effect.</p>							</div>
												</div>
				</div>
			</div>
				</div>
...
<input type="hidden" name="option_page" value="discussion"><input type="hidden" name="action" value="update"><input type="hidden" id="_wpnonce" name="_wpnonce" value="9b4ea5a7da"><input type="hidden" name="_wp_http_referer" value="/wp-admin/options-discussion.php?simply_static_page=85">
<table class="form-table" role="presentation">
<tr>
<th scope="row">Default post settings</th>
<td><fieldset>
<legend class="screen-reader-text"><span>
	Default post settings</span></legend>
<label for="default_pingback_flag">
<input name="default_pingback_flag" type="checkbox" id="default_pingback_flag" value="1" checked>
Attempt to notify any blogs linked to from the post</label>
<br>
<label for="default_ping_status">
<input name="default_ping_status" type="checkbox" id="default_ping_status" value="open" checked>
Allow link notifications from other blogs (pingbacks and trackbacks) on new posts</label>
<br>
<label for="default_comment_status">
<input name="default_comment_status" type="checkbox" id="default_comment_status" value="open" checked>
Allow people to submit comments on new posts</label>
<br>
<p class="description">Individual posts may override these settings. Changes here will only be applied to new posts.</p>
</fieldset></td>
</tr>
<tr>
...
<td><fieldset>
<legend class="screen-reader-text"><span>
	Other comment settings</span></legend>
<label for="require_name_email"><input type="checkbox" name="require_name_email" id="require_name_email" value="1" checked> Comment author must fill out name and email</label>
<br>
...
<input name="show_comments_cookies_opt_in" type="checkbox" id="show_comments_cookies_opt_in" value="1" checked>
Show comments cookies opt-in checkbox, allowing comment author cookies to be set</label>
<br>

<label for="thread_comments">
<input name="thread_comments" type="checkbox" id="thread_comments" value="1" checked>
Enable threaded (nested) comments </label> <label for="thread_comments_depth"><select name="thread_comments_depth" id="thread_comments_depth"><option value="2">2</option>
...
<option value="10">10</option></select> levels deep</label>
<br>
<label for="page_comments">
<input name="page_comments" type="checkbox" id="page_comments" value="1">
Break comments into pages with </label> <label for="comments_per_page"><input name="comments_per_page" type="number" step="1" min="0" id="comments_per_page" value="50" class="small-text"> top level comments per page and the </label> <label for="default_comments_page"><select name="default_comments_page" id="default_comments_page"><option value="newest" selected>last</option>
<option value="oldest">first</option></select> page displayed by default</label>
<br>
<label for="comment_order">
Comments should be displayed with the <select name="comment_order" id="comment_order"><option value="asc" selected>older</option>
<option value="desc">newer</option></select> comments at the top of each page</label>
</fieldset></td>
</tr>
<tr>
...
<td><fieldset>
<legend class="screen-reader-text"><span>
	Email me whenever</span></legend>
<label for="comments_notify">
<input name="comments_notify" type="checkbox" id="comments_notify" value="1" checked>
Anyone posts a comment </label>
<br>
<label for="moderation_notify">
<input name="moderation_notify" type="checkbox" id="moderation_notify" value="1" checked>
...
<td><fieldset>
<legend class="screen-reader-text"><span>
	Before a comment appears</span></legend>
<label for="comment_moderation">
<input name="comment_moderation" type="checkbox" id="comment_moderation" value="1">
Comment must be manually approved </label>
<br>
<label for="comment_previously_approved"><input type="checkbox" name="comment_previously_approved" id="comment_previously_approved" value="1" checked> Comment author must have a previously approved comment</label>
</fieldset></td>
</tr>
<tr>
...
<td><fieldset>
<legend class="screen-reader-text"><span>
	Comment Moderation</span></legend>
<p><label for="comment_max_links">
Hold a comment in the queue if it contains <input name="comment_max_links" type="number" step="1" min="0" id="comment_max_links" value="2" class="small-text"> or more links. (A common characteristic of comment spam is a large number of hyperlinks.)</label></p>

<p><label for="moderation_keys">When a comment contains any of these words in its content, author name, URL, email, IP address, or browser&#8217;s user agent string, it will be held in the <a href="/wp-admin/edit-comments.php?comment_status=moderated">moderation queue</a>. One word or IP address per line. It will match inside words, so &#8220;press&#8221; will match &#8220;WordPress&#8221;.</label></p>
<p>
...
<td><fieldset>
<legend class="screen-reader-text"><span>
	Disallowed Comment Keys</span></legend>
<p><label for="disallowed_keys">When a comment contains any of these words in its content, author name, URL, email, IP address, or browser&#8217;s user agent string, it will be put in the Trash. One word or IP address per line. It will match inside words, so &#8220;press&#8221; will match &#8220;WordPress&#8221;.</label></p>
<p>
<textarea name="disallowed_keys" rows="10" cols="50" id="disallowed_keys" class="large-text code"></textarea>
</p>
</fieldset></td>
</tr>
</table>
...
<td>
	<label for="show_avatars">
		<input type="checkbox" id="show_avatars" name="show_avatars" value="1" checked>
		Show Avatars	</label>
</td>
</tr>
...
<td><fieldset>
<legend class="screen-reader-text"><span>
	Maximum Rating</span></legend>


	<label><input type="radio" name="avatar_rating" value="G" checked> G &#8212; Suitable for all audiences</label><br>
...
For users without a custom avatar of their own, you can either display a generic logo or a generated one based on their email address.<br>
	...
	<label><input type="radio" name="avatar_default" id="avatar_mystery" value="mystery" checked> <img alt="" src="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=32&#038;d=mm&#038;f=y&#038;r=g" srcset="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=64&#038;d=mm&#038;f=y&#038;r=g 2x" class="avatar avatar-32 photo avatar-default" height="32" width="32" loading="lazy" decoding="async"> Mystery Person</label><br>
	<label><input type="radio" name="avatar_default" id="avatar_blank" value="blank"> <img alt="" src="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=32&#038;d=blank&#038;f=y&#038;r=g" srcset="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=64&#038;d=blank&#038;f=y&#038;r=g 2x" class="avatar avatar-32 photo avatar-default" height="32" width="32" loading="lazy" decoding="async"> Blank</label><br>
	<label><input type="radio" name="avatar_default" id="avatar_gravatar_default" value="gravatar_default"> <img alt="" src="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=32&#038;f=y&#038;r=g" srcset="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=64&#038;f=y&#038;r=g 2x" class="avatar avatar-32 photo avatar-default" height="32" width="32" loading="lazy" decoding="async"> Gravatar Logo</label><br>
	<label><input type="radio" name="avatar_default" id="avatar_identicon" value="identicon"> <img alt="" src="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=32&#038;d=identicon&#038;f=y&#038;r=g" srcset="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=64&#038;d=identicon&#038;f=y&#038;r=g 2x" class="avatar avatar-32 photo avatar-default" height="32" width="32" loading="lazy" decoding="async"> Identicon (Generated)</label><br>
	<label><input type="radio" name="avatar_default" id="avatar_wavatar" value="wavatar"> <img alt="" src="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=32&#038;d=wavatar&#038;f=y&#038;r=g" srcset="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=64&#038;d=wavatar&#038;f=y&#038;r=g 2x" class="avatar avatar-32 photo avatar-default" height="32" width="32" loading="lazy" decoding="async"> Wavatar (Generated)</label><br>
	<label><input type="radio" name="avatar_default" id="avatar_monsterid" value="monsterid"> <img alt="" src="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=32&#038;d=monsterid&#038;f=y&#038;r=g" srcset="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=64&#038;d=monsterid&#038;f=y&#038;r=g 2x" class="avatar avatar-32 photo avatar-default" height="32" width="32" loading="lazy" decoding="async"> MonsterID (Generated)</label><br>
	<label><input type="radio" name="avatar_default" id="avatar_retro" value="retro"> <img alt="" src="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=32&#038;d=retro&#038;f=y&#038;r=g" srcset="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=64&#038;d=retro&#038;f=y&#038;r=g 2x" class="avatar avatar-32 photo avatar-default" height="32" width="32" loading="lazy" decoding="async"> Retro (Generated)</label><br>
	<label><input type="radio" name="avatar_default" id="avatar_robohash" value="robohash"> <img alt="" src="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=32&#038;d=robohash&#038;f=y&#038;r=g" srcset="http://2.gravatar.com/avatar/e6d67fed862c439aa6e911ce49c7857d?s=64&#038;d=robohash&#038;f=y&#038;r=g 2x" class="avatar avatar-32 photo avatar-default" height="32" width="32" loading="lazy" decoding="async"> RoboHash (Generated)</label><br>
</fieldset></td>
</tr>
</table>
