...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Privacy &lsaquo; My WordPress Website &#8212; WordPress</title>
...
var ajaxurl = '/wp-admin/admin-ajax.php',
	pagenow = 'options-privacy',
	typenow = '',
	adminpage = 'options-privacy-php',
	thousandsSeparator = ',',
	decimalPoint = '.',
	isRtl = 0;</script>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396140","secure":""};/* ]]> */
</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/options-privacy.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js privacy-settings  options-privacy-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<li class="current"><a href="/wp-admin/options-privacy.php" class="current" aria-current="page">Privacy</a></li>
</ul>
</li>
	<li class="wp-not-current-submenu wp-menu-separator" aria-hidden="true"><div class="separator"></div></li>
...
<p><a href="https://wordpress.org/documentation/article/settings-privacy-screen/">Documentation on Privacy Settings</a></p>					</div>
...
<p>This screen includes suggestions to help you write your own privacy policy. However, it is your responsibility to use these resources correctly, to provide the information required by your privacy policy, and to keep this information current and accurate.</p>							</div>
												</div>
				</div>
			</div>
				</div>
		...
		<div id="setting-error-page_for_privacy_policy" class="notice notice-error settings-error is-dismissible"> 
<p><strong>The currently selected Privacy Policy page does not exist. Please create or select a new page.</strong></p>
</div> 
<div class="privacy-settings-header">
	...
	<nav class="privacy-settings-tabs-wrapper hide-if-no-js" aria-label="Secondary menu">
		<a href="/wp-admin/options-privacy.php" class="privacy-settings-tab active" aria-current="true">
			Settings		</a>

		<a href="/wp-admin/options-privacy.php?tab=policyguide" class="privacy-settings-tab">
			Policy Guide		</a>
	</nav>
</div>
...
<div class="notice notice-error hide-if-js"><p>The Privacy Settings require JavaScript.</p></div>
<div class="privacy-settings-body hide-if-no-js">
	<h2>Privacy Settings</h2>
	<p>
		As a website owner, you may need to follow national or international privacy laws. For example, you may need to create and display a privacy policy.		If you already have a Privacy Policy page, please select it below. If not, please create one.	</p>
	<p>
		The new page will include help and suggestions for your privacy policy.		However, it is your responsibility to use those resources correctly, to provide the information that your privacy policy requires, and to keep that information current and accurate.	</p>
	<p>
		After your Privacy Policy page is set, you should edit it.		You should also review your privacy policy from time to time, especially after installing or updating any themes or plugins. There may be changes or new suggested information for you to consider adding to your policy.	</p>
	<p>
		Need help putting together your new Privacy Policy page? <a href="/wp-admin/options-privacy.php?tab=policyguide">Check out our privacy policy guide</a> for recommendations on what content to include, along with policies suggested by your plugins and theme.	</p>
	<hr>
		<table class="form-table tools-privacy-policy-page" role="presentation">
		<tr>
			<th scope="row">
				<label for="create-page">
				Create a new Privacy Policy page				</label>
			</th>
			<td>
				<form class="wp-create-privacy-page" method="post">
					<input type="hidden" name="action" value="create-privacy-page">
					<input type="hidden" id="_wpnonce" name="_wpnonce" value="a7982da467"><input type="hidden" name="_wp_http_referer" value="/wp-admin/options-privacy.php?simply_static_page=88"><input type="submit" name="submit" id="create-page" class="button" value="Create">				</form>
			</td>
		</tr>
				<tr>
			<th scope="row">
				<label for="page_for_privacy_policy">
					Select a Privacy Policy page				</label>
			</th>
			<td>
				<form method="post">
	...
	<option class="level-1" value="10">&nbsp;&nbsp;&nbsp;WebAssembly PHP</option>
	<option class="level-2" value="13">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Asyncify</option>
	<option class="level-2" value="11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Compiling PHP</option>
	<option class="level-2" value="12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PHP Filesystem</option>
	<option class="level-0" value="7">Developer APIs</option>
	<option class="level-1" value="8">&nbsp;&nbsp;&nbsp;Query API</option>
	<option class="level-0" value="4">WordPress Playground</option>
	<option class="level-1" value="5">&nbsp;&nbsp;&nbsp;Overview</option>
	<option class="level-1" value="6">&nbsp;&nbsp;&nbsp;Start using WordPress Playground in 5 minutes</option>
</select>
<input type="hidden" id="_wpnonce" name="_wpnonce" value="fdbd062cf5"><input type="hidden" name="_wp_http_referer" value="/wp-admin/options-privacy.php?simply_static_page=88"><input type="submit" name="submit" id="set-page" class="button button-primary" value="Use This Page">				</form>
			</td>
		</tr>
			</table>
</div>
