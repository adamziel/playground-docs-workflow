...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Reading Settings &lsaquo; My WordPress Website &#8212; WordPress</title>
...
var ajaxurl = '/wp-admin/admin-ajax.php',
	pagenow = 'options-reading',
	typenow = '',
	adminpage = 'options-reading-php',
	thousandsSeparator = ',',
	decimalPoint = '.',
	isRtl = 0;</script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/options-reading.php">
...
<body class="wp-admin wp-core-ui no-js options-reading-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<li class="current"><a href="/wp-admin/options-reading.php" class="current" aria-current="page">Reading</a></li>
...
<p><a href="https://wordpress.org/documentation/article/settings-reading-screen/">Documentation on Reading Settings</a></p>
...
<p>You can choose what&#8217;s displayed on the homepage of your site. It can be posts in reverse chronological order (classic blog), or a fixed/static page. To set a static homepage, you first need to create two <a href="/wp-admin/post-new.php?post_type=page">Pages</a>. One will become the homepage, and the other will be where your posts are displayed.</p>
<p>You can also control the display of your content in RSS feeds, including the maximum number of posts to display and whether to show full text or an excerpt. <a href="https://wordpress.org/documentation/article/wordpress-feeds/">Learn more about feeds</a>.</p>
...
<p>When this setting is in effect, a reminder is shown in the At a Glance box of the Dashboard that says, &#8220;Search engines discouraged&#8221;, to remind you that you have directed search engines to not crawl your site.</p>							</div>
												</div>
				</div>
			</div>
				</div>
...
<input type="hidden" name="option_page" value="reading"><input type="hidden" name="action" value="update"><input type="hidden" id="_wpnonce" name="_wpnonce" value="1ca9397236"><input type="hidden" name="_wp_http_referer" value="/wp-admin/options-reading.php?simply_static_page=84">
<table class="form-table" role="presentation">
<tr>
<th scope="row">Your homepage displays</th>
<td id="front-static-pages"><fieldset>
	<legend class="screen-reader-text"><span>
		Your homepage displays	</span></legend>
	<p><label>
		<input name="show_on_front" type="radio" value="posts" class="tog" checked>
		Your latest posts	</label>
	</p>
	<p><label>
		<input name="show_on_front" type="radio" value="page" class="tog">
		A <a href="/wp-admin/edit.php?post_type=page">static page</a> (select below)	</label>
	</p>
<ul>
	...
	<option class="level-0" value="4" selected>WordPress Playground</option>
...
<td>
<input name="posts_per_rss" type="number" step="1" min="1" id="posts_per_rss" value="10" class="small-text"> items</td>
</tr>
<tr>
<th scope="row">For each post in a feed, include </th>
<td><fieldset>
	<legend class="screen-reader-text"><span>
		For each post in a feed, include	</span></legend>
	<p>
		<label><input name="rss_use_excerpt" type="radio" value="0" checked> Full text</label><br>
		<label><input name="rss_use_excerpt" type="radio" value="1"> Excerpt</label>
	</p>
	<p class="description">
		Your theme determines how content is displayed in browsers. <a href="https://wordpress.org/documentation/article/wordpress-feeds/">Learn more about feeds</a>.	</p>
</fieldset></td>
</tr>
...
<td><fieldset>
	<legend class="screen-reader-text"><span>
		Search engine visibility	</span></legend>
