...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Writing Settings &lsaquo; My WordPress Website &#8212; WordPress</title>
...
var ajaxurl = '/wp-admin/admin-ajax.php',
	pagenow = 'options-writing',
	typenow = '',
	adminpage = 'options-writing-php',
	thousandsSeparator = ',',
	decimalPoint = '.',
	isRtl = 0;</script>
...
<script>
/* <![CDATA[ */
var userSettings = {"url":"\/","uid":"1","time":"1714396135","secure":""};var _zxcvbnSettings = {"src":"\/wp-includes\/js\/zxcvbn.min.js"};/* ]]> */
</script>
<script src="/wp-admin/load-scripts.php?c=0&amp;load%5Bchunk_0%5D=jquery-core%2Cjquery-migrate%2Cutils%2Cwp-polyfill-inert%2Cregenerator-runtime%2Cwp-polyfill%2Czxcvbn-async&amp;ver=6.5.2"></script>
...
<script type="text/javascript">var _wpColorScheme = {"icons":{"base":"#a7aaad","focus":"#72aee6","current":"#fff"}};</script>
	<link id="wp-admin-canonical" rel="canonical" href="/wp-admin/options-writing.php">
	<script>if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'wp-admin-canonical' ).href + window.location.hash );
		}</script>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
</head>
<body class="wp-admin wp-core-ui no-js options-writing-php auto-fold admin-bar branch-6-5 version-6-5-2 admin-color-fresh locale-en-us no-customize-support no-svg">
...
<li class="current"><a href="/wp-admin/options-writing.php" class="current" aria-current="page">Writing</a></li>
...
<p><a href="https://wordpress.org/documentation/article/settings-writing-screen/">Documentation on Writing Settings</a></p>
...
<p>You must click the Save Changes button at the bottom of the screen for new settings to take effect.</p>							</div>
							...
							<div id="tab-panel-options-postemail" class="help-tab-content">
								<p>Post via email settings allow you to send your WordPress installation an email with the content of your post. You must set up a secret email account with POP3 access to use this, and any mail received at this address will be posted, so it&#8217;s a good idea to keep this address very secret.</p>							</div>
							
							<div id="tab-panel-options-services" class="help-tab-content">
								<p>If desired, WordPress will automatically alert various services of your new posts.</p>							</div>
												</div>
				</div>
			</div>
				</div>
...
<input type="hidden" name="option_page" value="writing"><input type="hidden" name="action" value="update"><input type="hidden" id="_wpnonce" name="_wpnonce" value="2557ee8c98"><input type="hidden" name="_wp_http_referer" value="/wp-admin/options-writing.php?simply_static_page=83">
...
<select name="default_category" id="default_category" class="postform">
	<option class="level-0" value="1" selected>Uncategorized</option>
</select>
</td>
</tr>
<tr>
...
<p>
	To post to WordPress by email, you must set up a secret email account with POP3 access. Any mail received at this address will be posted, so it&#8217;s a good idea to keep this address very secret. Here are three random strings you could use: <kbd>odz5vxVv</kbd>, <kbd>LUBlcY80</kbd>, <kbd>6iCb12tU</kbd>.</p>

<table class="form-table" role="presentation">
<tr>
<th scope="row"><label for="mailserver_url">Mail Server</label></th>
<td>
<input name="mailserver_url" type="text" id="mailserver_url" value="mail.example.com" class="regular-text code">
...
<tr class="mailserver-pass-wrap">
	...
	<td>
		...
		<span class="wp-pwd">
			<input type="text" name="mailserver_pass" id="mailserver_pass" class="regular-text ltr" autocomplete="off" data-reveal="1" data-pw="password">
			<button type="button" class="button wp-hide-pw hide-if-no-js" data-toggle="0" data-start-masked="1" aria-label="Hide password">
...
<h2 class="title">Update Services</h2>
	...
	<p><label for="ping_sites">
		When you publish a new post, WordPress automatically notifies the following site update services. For more about this, see the <a href="https://wordpress.org/documentation/article/update-services/">Update Services</a> documentation article. Separate multiple service URLs with line breaks.	</label></p>
...
<script src="/wp-admin/js/password-strength-meter.min.js?ver=6.5.2" id="password-strength-meter-js"></script>
<script src="/wp-includes/js/underscore.min.js?ver=1.13.4" id="underscore-js"></script>
<script id="wp-util-js-extra">var _wpUtilSettings = {"ajax":{"url":"\/wp-admin\/admin-ajax.php"}};</script>
<script src="/wp-includes/js/wp-util.min.js?ver=6.5.2" id="wp-util-js"></script>
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"0612ec9e42"};</script>
<script src="/wp-admin/js/user-profile.min.js?ver=6.5.2" id="user-profile-js"></script>
